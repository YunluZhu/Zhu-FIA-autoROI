...
#%%
all_amp_long, amp_QC, amp_goodFit, amp_goodTuning = doQC_getSlope_4lesion(root)
...
df_oneTimePersti_sel = df_oneTimePersti_sel.query("cond_num == 1")

# determine peak timing category
df_oneTimePersti_sel_oneTimePerROI = df_oneTimePersti_sel.groupby(['ROI_id', 'nsti'])['peak_time_adj'].mean().reset_index()
